...
def main():
    ...
    # TODO parameterize the val_loader
    val_loader = dataset.get_dataloader(
        "/home/varun/datasets/VQA2/v2_mscoco_val2014_annotations.json",
        "/home/varun/datasets/VQA2/v2_OpenEnded_mscoco_val2014_questions.json",
        "coco_val_vgg_fc7.pth",
        "val",
        args
    )
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        trainer.evaluate(model, val_loader, criterion, epoch)
